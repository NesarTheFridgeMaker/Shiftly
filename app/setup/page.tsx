    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f7f7f8] px-4 py-8 sm:px-6">
      ...
      <section className="relative z-10 mx-auto mt-16 w-full max-w-5xl rounded-3xl border border-white bg-white/95 p-6 shadow-2xl sm:mt-20 sm:p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-5 sm:p-6">
            <div className="mb-5">
              <h2 className="text-xl font-semibold tracking-[-0.02em] text-slate-900">Preis</h2>
              <p className="mt-1 text-sm leading-6 text-slate-500">
                Ein Tarif mit allen Funktionen. Die Abrechnung richtet sich automatisch nach der Anzahl deiner aktiven Dipera-Mitarbeiterkonten.
              </p>
            </div>

            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl bg-slate-50 px-5 py-4">
                <p className="text-sm text-slate-500">Grundpreis</p>
                <p className="mt-1 text-2xl font-semibold text-blue-950">
                  29,90 € <span className="text-sm font-medium text-slate-500">netto / Monat</span>
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Inklusive bis zu 10 aktiver Mitarbeiterkonten und aller Funktionen.
                </p>
              </div>

              <div className="rounded-2xl bg-slate-50 px-5 py-4">
                <p className="text-sm text-slate-500">Ab dem 11. Mitarbeiter</p>
                <p className="mt-1 text-2xl font-semibold text-blue-950">
                  +3,49 € <span className="text-sm font-medium text-slate-500">netto / Monat</span>
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Je zusätzlichem aktiven Mitarbeiterkonto. Aktivierungen im laufenden Abrechnungszeitraum werden anteilig berechnet.
                </p>
              </div>
            </div>

            <p className="mt-4 text-sm leading-6 text-slate-500">
              Der Owner zählt als aktives Mitarbeiterkonto. Deaktivierungen reduzieren die Abrechnung ab dem nächsten Abrechnungszeitraum.
            </p>
          </div>
          ...
          <button type="button" onClick={() => void handleStartCheckout()} disabled={isLoading} className="h-14 w-full rounded-2xl bg-[#005CA8] px-6 font-semibold text-white transition hover:bg-[#004b8a] disabled:cursor-not-allowed disabled:bg-gray-400">
            ...
            {isLoading ? "Testphase wird gestartet..." : "14 Tage kostenlos testen & Betrieb erstellen"}

          </button>

          <p className="text-center text-xs leading-relaxed text-slate-500">14 Tage kostenlos. Danach 29,90 € netto pro Monat inklusive bis zu 10 aktiver Mitarbeiterkonten, anschließend 3,49 € netto je weiterem aktiven Mitarbeiterkonto. Monatlich kündbar.</p>
